    ...
    <main class=" flex justify-center items-center">
        <div id="myModal" class="">
            <div class="modal-content">
                ...
                <?php 
                    $query = "SELECT name_alumno, apellido_alumno, matricula, correo_alumno, address, fechaNacimiento FROM alumno where id_alumno = :id ";
                    $conn = new data();
                ...
                <form action="/index.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="dni" id="dni" class="input-field" value="<?= $dato['matricula']?>" required>
                    </div>
                    <div class="form-group">
                        <label class="font-bold " for="correo">Correo Electronico</label>
                        <input type="email" name="correo" id="correo" class="input-field" value="<?= $dato['correo_alumno']?>" readonly> 
                    </div>
                    <div class="form-group">
                        <label class="font-bold " for="nombre">Nombre(s)</label>
                        <input type="text" name="nombre" id="nombre" class="input-field" value="<?= $dato['name_alumno']?>" required>
                    </div>
                    <div class="form-group">
                        <label class="font-bold " for="apellido">Apellido(s)</label>
                        <input type="text" name="apellido" id="apellido" class="input-field" value="<?= $dato['apellido_alumno']?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="text" value="<?=$id_alumno?>" name="id" hidden>
